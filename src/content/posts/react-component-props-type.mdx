---
title: React 요소의 속성을 컴포넌트의 props로 사용하기
description: 컴포넌트의 props를 `React.ComponentProps` 타입으로 설정하면 React 요소의 속성을 컴포넌트의 props로 전달할 수 있습니다.
...
스타일링을 위해 다음과 같이 버튼에 클래스를 추가하려고 합니다.
...
```tsx
import type { ComponentProps } from 'react'   // [!code ++]

type ButtonProps = ComponentProps<'button'>   // [!code ++]
